...
from utils import (mean_average_precision, cells_to_bboxes, get_evaluation_bboxes, save_checkpoint, load_checkpoint, check_class_accuracy, get_loaders, plot_couple_examples)
...
def main():
    ...
    train_loader, test_loader = get_loaders(train_csv_path = "./data/mycsvfile_train.csv", test_csv_path="./data/mycsvfile_test.csv")
